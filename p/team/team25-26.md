		...
		<div class="content">
			<div class="inner">
				...
				<ul class="actions">
					...
					<li><a href="https://substack.com/@financewithfarhan" class="button" class="fa fa-2x fa-external-link" target="_blank"></a></li>
...
<section id="three" style="display: flex; justify-content: flex-start;">
	<div class="inner">
		<header class="major">
			<h2>Previous Teams</h2>
		</header>
		<section><p>DAMP Team from last year!</p></section>
		<ul class="actions">
